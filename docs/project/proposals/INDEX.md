...
Structured proposals generated from prompt files using the `/propose` skill. Each proposal contains critical analysis, alternatives, and implementation details for human review and decision-making.
